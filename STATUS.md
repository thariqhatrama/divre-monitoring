...
|---|---|---|---|---|---|
| 2026-06-10 | Change | Tampilan Nama Cabang | Mengganti tampilan UUID cabang menjadi nama/kode cabang pada Home, Master Data User, Parent Cabang, Dashboard Cabang, tabel proyek, dan form proyek PM; response login dan list user kini menyertakan relasi cabang; frontend build berhasil dengan warning chunk size Vite/Recharts yang sudah dikenal | `backend/src/models/user.model.js`, `backend/src/controllers/auth.controller.js`, `frontend/src/App.jsx`, `frontend/src/pages/MasterData.jsx`, `frontend/src/pages/DashboardCabang.jsx`, `frontend/src/pages/Dashboard.jsx`, `frontend/src/components/ProyekTable.jsx`, `frontend/src/pages/ProyekForm.jsx`, `frontend/src/pages/AuditLog.jsx`, `frontend/src/pages/UserGuide.jsx`, `STATUS.md` | ✅ |
| 2026-06-10 | Add | Login, Panduan, CRUD Master | Menambahkan tombol tampil/sembunyi password di login, halaman Panduan Pengguna per role, menu Panduan di sidebar, dan CRUD admin berbasis create/edit/aktif-nonaktif untuk COA 2025, cabang, serta user; frontend build berhasil dengan warning chunk size Vite/Recharts yang sudah dikenal | `frontend/src/pages/Login.jsx`, `frontend/src/pages/UserGuide.jsx`, `frontend/src/pages/MasterData.jsx`, `frontend/src/App.jsx`, `frontend/src/components/layout/Sidebar.jsx`, `frontend/src/App.css`, `STATUS.md` | ✅ |
